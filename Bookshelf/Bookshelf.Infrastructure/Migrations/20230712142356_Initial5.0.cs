        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Motivation = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RequestsUpvotes", x => new { x.RequestId, x.UserId });
                    table.ForeignKey(
                        name: "FK_RequestsUpvotes_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RequestsUpvotes_Requests_RequestId",
                        column: x => x.RequestId,
                        principalTable: "Requests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "6d5800ce-d726-4fc8-83d9-d6b3ac1f591e", 0, "684904be-8e10-4456-9de3-293a0af9007c", "ApplicationUser", "guest@gmail.com", false, "Ivan", "Georgiev", false, null, "GUEST@GMAIL.COM", "IVAN", "AQAAAAEAACcQAAAAEJFkYjlT61zz8Ge/BJUYnZoKQxGKoaKo3mgtZy+hasFZIvVNMgEoy1HYVBSPhopGIA==", null, false, "29f60d06-c31d-4d4d-a9cd-ae0fc049a26b", false, "ivan" });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Discriminator", "Email", "EmailConfirmed", "FirstName", "LastName", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { "dea12856-c198-4129-b3f3-b893d8395082", 0, "cda5f7d6-8d55-49c4-9fea-065af7aee8aa", "ApplicationUser", "admin@gmail.com", false, "Spiridon", "Stamatov", false, null, "ADMIN@GMAIL.COM", "SPIRIDON", "AQAAAAEAACcQAAAAEC8Rx79PvnsC5/DHV12AvIObBxZDQe51GdB0wKJpKOrUDHS02r12oPFAkRIRvs2pyA==", null, false, "89d44388-f622-43fe-aaa3-9f7e4c84657a", false, "Spiridon" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RequestsUpvotes_UserId",
                table: "RequestsUpvotes",
                column: "UserId");
